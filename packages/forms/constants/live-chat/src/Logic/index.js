 ...
 */
export const getArchives = () => ChatSDK.methodFactory({
 ...
 */
export const getChatThreads = (chat_id, thread_ids) => ChatSDK.methodFactory({
	action  : 'list_threads',
...
export const resumeChat = (chat_id) => ChatSDK.methodFactory({
	action  : 'resume_chat',
...
export const getCustomer = (id) => ChatSDK.methodFactory({
	action  : 'get_customer',
	payload : { id },
});
