...
const navigationMappings = {
	...
	app_dashboard: {
		...
		icon          : 'nav-tasks',
		main_apis     : [],
		possible_apis : [...apis.app_dashboard, ...apis.app_pay_later],
	...
	app_discover_rates: {
		...
		possible_apis : apis.app_discover_rates,
		module_type   : 'crm',
	},
	app_contract_rates: {
		...
		possible_apis : apis.app_contract_rates,
		module_type   : 'crm',
	},
	saas_freight_rate_trend: {
		...
		possible_apis : apis.saas_freight_rate_trend,
		module_type   : 'crm',
	},
	app_auto_quotation: {
		...
		line          : true,
		main_apis     : [],
		possible_apis : apis.app_auto_quotation,
		module_type   : 'dashboards',
	},
	app_accept_terms_and_conditions: {
		...
		// icon: 'nav-documents',
		main_apis     : [],
		possible_apis : apis.app_accept_terms_and_conditions,
		module_type   : 'dashboards',
		showInNav     : false,
	},
	app_documents: {
		...
		possible_apis : apis.app_documents,
		module_type   : 'dashboards',
	},
	saas_schedules: {
		key         : 'saas_schedules',
		...
		options     : [
			{
				...
				type          : 'link',
				main_apis     : [],
				possible_apis : apis.saas_map_tracking,
			},
			{
				...
				main_apis     : [],
				possible_apis : apis.saas_air_schedules,
			},
			{
				...
				main_apis     : [],
				possible_apis : apis.saas_schedules,
			},
		],
	},
	...
	// 	possible_apis: apis.app_bookings,
	// 	module_type: 'crm',
	// },
	saas_tracking: {
		key       : 'saas_tracking',
		...
		options   : [
			...
			},
			{
				...
				main_apis     : [],
				possible_apis : apis.saas_air_tracking,
			},
			{
				...
				main_apis     : [],
				possible_apis : apis.saas_tracking,
			},
		],
		module_type: 'dashboards',
	},
	hs_code_classification: {
		...
		main_apis     : [],
		line          : true,
		possible_apis : apis.saas_hs_code_list,
		isNew         : true,
		module_type   : 'dashboards',
	},
		...
		options     : [
			{
				...
				main_apis     : [],
				possible_apis : apis.saas_cogo_subscription,
			},
			{
	...
	// 	possible_apis: apis.saas_app_quotation,
	// 	isNew: true,
	// 	module_type: 'dashboards',
	// },
	saas_quick_insurance: {
		key           : 'saas_quick_insurance',
		title         : 'Insurance',
		...
		icon          : 'nav-insurance',
		main_apis     : [],
		possible_apis : apis.saas_insurance,
		module_type   : 'dashboards',
		isNew         : true,
		showInNav     : true,
	},
	...
	// // 	main_apis: [],
	// // 	possible_apis: apis.saas_transaction_history,
	// // 	isNew: true,
	// // 	module_type: 'dashboards',
	// // },
	// saas_subscription: {
	...
	// 	icon: 'nav-subscriptions',
	// 	main_apis: [],
	// 	possible_apis: apis.saas_subscription,
	// 	module_type: 'dashboards',
	// 	showInNav: false,
	// },
	// app_get_started: {
	...
	// 	icon          : 'nav-checklist',
	// 	main_apis     : [],
	// 	possible_apis : apis.app_get_started,
	// 	module_type   : 'dashboards',
	// },
	...
	// // 	main_apis: [],
	// // 	showInNav: false,
	// // 	possible_apis: apis.app_settings,
	// // 	module_type: 'dashboards',
	// // },
	// app_pricing: {
	// 	key           : 'app_pricing',
	...
	// 	main_apis     : [],
	// 	showInNav     : false,
	// 	possible_apis : apis.app_pricing,
	// 	module_type   : 'dashboards',
	// },
	// // saas_cogopoint: {
	// // 	key: 'saas_cogopoint',
	...
	// // 	icon: 'nav-payments',
	// // 	main_apis: [],
	// // 	possible_apis: apis.saas_cogopoint,
	// // 	module_type: 'dashboards',
	// // 	onlyMobile: 'true',
	// // },
	// // saas_trade_partner: {
	...
	// // 	main_apis: [],
	// // 	possible_apis: apis.saas_trade_partner,
	// // 	module_type: 'dashboards',
	// // 	isNew: true,
	// // 	showInNav: true,
	// // 	line: true,
	...
	// // 	icon: 'nav-payments',
	// // 	main_apis: [],
	// // 	possible_apis: apis.app_payments,
	// // 	module_type: 'dashboards',
	// // },
	...
	// 	icon: 'nav-catalog',
	// 	main_apis: [],
	// 	possible_apis: apis.saas_product_inventory,
	// 	module_type: 'dashboards',
	// 	isNew: true,
	// 	showInNav: true,
	// },

	// // saas_container_calculator: {
	// // 	key: 'saas_container_calculator',
	// // 	title: 'Container Calculator',
	// // 	href: '/saas/container-calculator',
	// // 	as: '/saas/container-calculator',
	// // 	type: 'link',
	// // 	icon: 'nav-catalog',
	// // 	main_apis: [],
	// // 	possible_apis: apis.saas_container_calculator,
	// // 	module_type: 'dashboards',
	// // 	isNew: true,
	// // 	showInNav: true,
	// // },
