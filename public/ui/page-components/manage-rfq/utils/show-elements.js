import { HAZ_CLASSES } from '../configurations/commodities-mapping';
...
const getFunction = {
	...
	export_transportation_cargo_handling_type: (control, formValues) => (
		control.condition?.export_transportation_cargo_handling_type?.includes(
			formValues.export_transportation_cargo_handling_type,
		)),

	export_cfs_cargo_handling_type: (control, formValues) => (
		control.condition?.export_cfs_cargo_handling_type?.includes(
	...
	import_transportation_cargo_handling_type: (control, formValues) => (
		control.condition?.import_transportation_cargo_handling_type?.includes(
	...
	destination_country: (control, formValues, mode, location) => (
		(control?.condition?.destination_country || []).includes(
