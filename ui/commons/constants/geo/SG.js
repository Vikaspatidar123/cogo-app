export default {
	...
	country          : {
		id   : '6e18d508-87b9-4e7e-a785-b47edc76b0b7',
		name : 'Singapore',
		code : 'SG',
		flag_icon_url:
		'https://prod-cogoport.s3.ap-south-1.amazonaws.com/Singapore_24.png',
		currency: {
			code   : 'SGD',
			symbol : '$',
		},
	...
	lcw_timer                     : 10000,
	customer_support              : 'support.sg@cogoport.com',
	default_agent                 : {
		name                  : 'Kanira Patel',
