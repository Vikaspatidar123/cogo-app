export default {
	parent_entity_id : '6d92cf58-3392-44c3-8e1b-09192f98f8be',
	country          : {
		id   : '61a683f3-128b-4193-98f7-dd72f68db03d',
		name : 'Thailand',
		code : 'TH',
		flag_icon_url:
			'https://prod-cogoport.s3.ap-south-1.amazonaws.com/Thailand_24.png',
		currency: {
			code   : 'THB',
			symbol : '฿',
		},
