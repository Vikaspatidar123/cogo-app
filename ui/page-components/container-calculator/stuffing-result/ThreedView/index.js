...
// const ThreedView = ({ isOpen, setShowModal }) => {
// 	const onOuterClick = () => {
// 		setShowModal(false);
// 	};

// 	const loadGLTFModel = (scene, glbPath, options) => {
...
// 				View.setSize(scW, scH);
// 				View.outputEncoding = THREE.sRGBEncoding;
...
// 	return (
// 		<Modal width="400" onClose={setShowModal} show={isOpen} onOuterClick={onOuterClick}>
// 			<Container>
