			...
			<div className={styles.card}>
				...
				<div>
					<ul>
						...
						<li>Please wait for some time as your email provider can be a little slow some times.</li>
						<li>Please check your spam inbox if you are still unable to receive the email.</li>
					</ul>
				</div>
			</div>
			<div className={styles.footer}>
				Didn't receive the password reset link?
				<Button themeType="tertiary" className={styles.button} onClick={handleClick}>RESEND RESET EMAIL</Button>
			</div>
		</div>
	);
}
