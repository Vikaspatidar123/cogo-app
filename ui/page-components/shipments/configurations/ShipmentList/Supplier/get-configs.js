import air_customs from '../../Services/air-customs.json';
import air_freight from '../../Services/air-freight.json';
import air_freight_local_service from '../../Services/air-local.json';
import allServices from '../../Services/all-services.json';
import fcl_cfs from '../../Services/fcl-cfs.json';
import fcl_customs from '../../Services/fcl-customs.json';
import fcl_freight from '../../Services/fcl-freight.json';
import fcl_freight_local_service from '../../Services/fcl-local.json';
import ftl_freight from '../../Services/ftl-freight.json';
import haulage_freight from '../../Services/haulage-freight.json';
import lcl_customs from '../../Services/lcl-customs.json';
import lcl_freight from '../../Services/lcl-freight.json';
import lcl_freight_local_service from '../../Services/lcl-local.json';
import ltl_freight from '../../Services/ltl-freight.json';
import trailer_freight from '../../Services/trailer-freight.json';
