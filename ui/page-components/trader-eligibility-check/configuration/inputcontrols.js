...
const getControls = ({ setCountryDetails, formDetails, countryOptions, t }) => {
	const controls = [
		...
		{
			label       : t('traderEligibilityChecl:tec_form_state_label'),
			name        : 'state',
			type        : 'text',
			placeholder : t('traderEligibilityChecl:tec_form_state_label'),
			width       : '45%',
		},
		{
			label       : t('traderEligibilityChecl:tec_form_city_label'),
			name        : 'city',
			type        : 'text',
			placeholder : t('traderEligibilityChecl:tec_form_city_label'),
			width       : '45%',
		},
		{
			label       : t('traderEligibilityChecl:tec_form_address_label'),
			name        : 'address',
			type        : 'text',
